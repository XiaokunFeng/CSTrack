...
class CSTRACKS1(BaseTracker):
    def __init__(self, params, dataset_name):
        super(CSTRACKS1, self).__init__(params)
        network = build_cstrack_s1(params.cfg)
    ...
    def track(self, image, info: dict = None):
        ...
        # run the encoder
        with torch.no_grad():
            out_dict = self.network(self.template_list, search, self.soft_token_template_mask, training=False)
